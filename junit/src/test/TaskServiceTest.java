...
class TaskServiceTest {
  ...
  void newTaskTest() {
    ...
    service.newTask(id, name, description);
  ...
  void newTaskTooLongNameTest() {
    ...
    Assertions.assertThrows(IllegalArgumentException.class,
                            () -> service.newTask(tooLongName, description, description));
  }
  ...
  void newTaskTooLongDescriptionTest() {
    ...
    assertThrows(IllegalArgumentException.class,
                 () -> service.newTask(name, tooLongDescription, description));
  }

  @Test
  void newTaskNameNullTest() {
    TaskService service = new TaskService();
    assertThrows(IllegalArgumentException.class, () -> service.newTask(null, description, description));
  }
  ...
  void newTaskDescriptionNullTest() {
    TaskService service = new TaskService();
    assertThrows(IllegalArgumentException.class,
                 () -> service.newTask(name, null, description));
  }
